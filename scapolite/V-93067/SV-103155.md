...
title: Windows Server 2019 Force shutdown from a remote system user right must only
  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:mil.disa.stig.windows:def:2181
