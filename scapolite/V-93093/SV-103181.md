...
title: Windows Server 2019 must be configured to audit Policy Change - Audit Policy
    Change successes.
rule: <see below>
  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:mil.disa.stig.windows:def:2041
