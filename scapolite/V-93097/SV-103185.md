...
title: Windows Server 2019 must be configured to audit Policy Change - Authentication
...
applicability:
  - system: org.scapolite.xccdf.applicability
    ...
    severity: medium
implementations:
  - relative_id: F-99343r1
    description: <see below>
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:mil.disa.stig.windows:def:2043
