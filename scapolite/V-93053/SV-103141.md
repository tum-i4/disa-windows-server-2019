...
title: Windows Server 2019 Back up files and directories user right must only be assigned
  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:mil.disa.stig.windows:def:2174
