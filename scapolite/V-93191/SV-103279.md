...
title: Windows Server 2019 permissions for the Security event log must prevent access
...
applicability:
  - system: org.scapolite.xccdf.applicability
    ...
    severity: medium
implementations:
  - relative_id: F-99437r1
    description: <see below>
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:mil.disa.stig.windows:def:2199
