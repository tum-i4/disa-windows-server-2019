...
title: Windows Server 2019 Create a pagefile user right must only be assigned to the
...
applicability:
  - system: org.scapolite.xccdf.applicability
    ...
    severity: medium
implementations:
  - relative_id: F-99301r1
    description: <see below>
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:mil.disa.stig.windows:def:2175
